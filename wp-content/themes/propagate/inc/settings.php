...
function threeseven_theme_setup() {
	...
	threeseven_add_theme_support( $features );
...
/**
 * Loop through available features and add theme to the theme support
 * @param array $features array of features
 */
function three_seven_add_theme_support( $features ) {
...
function threeseven_modify_footer_admin () {
  echo 'Created by <a href="http://3.7designs.co" target="_new">3.7 DESIGNS</a>.';
  echo 'Powered by <a href="http://WordPress.org" target="_new">WordPress</a>.';
}
add_filter( 'admin_footer_text', 'threeseven_modify_footer_admin' );

function threeseven_robots() {
...
add_action( 'do_robots', 'threeseven_robots' );
...
function threeseven_dashboard_widgets() {
     ...
     wp_add_dashboard_widget( 'dashboard_custom_feed', 'News from 3.7 DESIGNS', 'threeseven_dashboard_custom_feed_output' ); //add new RSS feed output
}
add_action('wp_dashboard_setup', 'threeseven_dashboard_widgets' );

function threeseven_dashboard_custom_feed_output() {
